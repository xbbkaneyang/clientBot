...
var debugLogger = require('pomelo-logger').getLogger('rpc-debug');
...
SessionService.prototype.bind = function(sid, uid, cb) {
  ...
  debugLogger.debug( "SessionService.bind : " + sid + " uid : " + uid );
  if(!session) {
...
Session.prototype.send = function(msg) {
  ...
  if ( this.__socket__.socket.readyState !== WebSocket_OPEN ) {
      ...
      logger.warn('socket readyState is not WebSocket_OPEN : ' , this.__socket__.socket.readyState );
      return;
  }
