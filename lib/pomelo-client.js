/**
 * Created by William on 14/02/2017.
 */
...
//	return new Message(data.id, data.route, data.msg);
	...
	console.log( 'route=%s , length=%s' , route , len );
	return new Message(id, route, body);
};

// var message = {u:'d'};
// var enen = Protocol.encode(  1 , 'updateFishBattleInfo' , message );
// console.info( enen );
// var dede = Protocol.decode( enen );
// console.info( dede );
