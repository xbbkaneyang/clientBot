...
export class BCRobot extends LiveRobotBase {
    ...
    protected handleRoundEnd( data: any ) {
        ...
        let b1 = data.cs.b1;
        let b2 = data.cs.b2;
        let b3 = !data.cs.b3 || data.cs.p3 === '' ? null : data.cs.b3;
        let p1 = data.cs.p1;
        let p2 = data.cs.p2;
        let p3 = !data.cs.p3 || data.cs.p3 === '' ? null : data.cs.p3;
        let bCount = !!b3 ? 3 : 2;
        let pCount = !!p3 ? 3 : 2;
